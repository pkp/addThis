...
<form class="pkp_form" id="statisticsDisplayForm">
	{capture assign="addThisStatisticsGridUrl"}{url router=\PKP\core\PKPApplication::ROUTE_COMPONENT component="plugins.generic.addThis.controllers.grid.AddThisStatisticsGridHandler" op="fetchGrid" escape=false}{/capture}
